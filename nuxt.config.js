...
module.exports = {
  ...
  */
    ...
    socialMedia: [  // social media serwera
      {
        ...
        "link": "https://discord.gg/jjvkjR3W5g"
      },
      {
        "name": "TikTok",
        "icon": "https://i.imgur.com/w8CLcAH.png",
        "link": "https://www.tiktok.com/@officialtheschab"
      },
      {
        "name": "Facebook",
  ...
  head: {
    title: 'TheStart',  // tytuł strony
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { hid: 'description', name: 'description', TheStart' }  // opis strony dla wyszukiwarek i discorda
    ],
    link: [
